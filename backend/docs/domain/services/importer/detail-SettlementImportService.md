...
- [SettlementReportService](../../common/detail-SettlementReportService.md) (Domain Service)
- [SettlementReportProcessor](detail-SettlementReportProcessor.md) (Processor)
